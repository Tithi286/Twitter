...
class subscribers extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("http://localhost:3001/lists/subscribers", data)
            .then((response) => {
                this.setState({
        ...
        return (
            <div class="container-flex">
                ...
                <div class="col-md-3 feed1" >
                    ...
                    <span class="home-buttons1"><img src="https://library.kissclipart.com/20180904/ese/kissclipart-user-icon-png-clipart-computer-icons-user-66fe7db07b02eb73.jpg" class="logo4"></img>Profile</span><br /><br />
