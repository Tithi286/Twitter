    ...
    render() {
        ...
        return (
                ...
                <div class="col-md-3 feed1" style={{borderRight:"1px solid black"}}>
                    <span class="home-buttons"><img src="https://www.alc.edu/wp-content/uploads/2016/10/13-twitter-logo-vector-png-free-cliparts-that-you-can-download-to-you-Km878c-clipart.png" class="logo"></img><span style={{marginLeft:"15px",fontSize:"15px"}}>Hello, {sessionStorage.getItem("username")}</span></span><br /><br />
